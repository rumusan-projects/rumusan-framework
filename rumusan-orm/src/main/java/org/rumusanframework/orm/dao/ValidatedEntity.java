...
/**
 * The concrete implementation will contain Bean Validation API annotation like {@link NotNull},
 * {@link NotEmpty} to be validated using {@link Validator}.<br/> Example of code:<br/>
 *
 * <pre>
