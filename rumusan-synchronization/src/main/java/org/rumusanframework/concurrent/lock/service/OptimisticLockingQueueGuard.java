...
public class OptimisticLockingQueueGuard implements QueueGuard {
  ...
  @Override
  public GroupLock checkIn(Class<? extends LockingProcess<GroupLock>> classCaller,
  ...
  private void throwConcurrentProcess(Class<? extends LockingProcess<GroupLock>> classCaller,
      GroupLock groupLock,
      boolean isValid) throws ConcurrentAccessException {
    if (!isValid) {
      throw new ConcurrentAccessException("Found concurrent process in the same group.",
          classCaller,
  ...
  private void validateOptimisticUpdate(Class<? extends LockingProcess<GroupLock>> classCaller,
      GroupLock groupLock,
      boolean ignoreSameProcess) throws ConcurrentAccessException {
