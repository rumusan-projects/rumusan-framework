...
public class ResolverTest {
	...
	public void testInlineResolveFirstAttempt() {
		InLineResolver resolver = new InLineResolver(getClass(), Id1.class, Id2.class, Id3.class, Id4.class, Id5.class,
				Id6.class);
	...
	public void testRecursiveResolveFirstAttempt() {
		RecursiveResolver resolver = new RecursiveResolver(getClass(), Id1.class, Id2.class, Id3.class, Id4.class,
				Id5.class, Id6.class);
		String value = ResolverUtils.concate(resolver);
		assertEquals("id1.id2.id3.id5.id6", value);
	}
	...
	public void testResolveUtils() {
		RecursiveResolver resolver1 = new RecursiveResolver(getClass(), Id1.class, Id2.class, Id3.class, Id4.class,
				Id5.class, Id6.class);
		InLineResolver resolver2 = new InLineResolver(getClass(), Id1.class, Id2.class, Id3.class, Id4.class, Id5.class,
				Id6.class);
