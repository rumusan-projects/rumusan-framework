...
/**
 * Test for java type:<br/> - Byte<br/> - Short<br/> - Integer<br/> - Long<br/> - Float<br/> -
 * Double<br/> - BigInteger<br/> - BigDecimal<br/> - Character<br/> - String<br/> - Boolean<br/> -
 * java.sql.Date<br/> - java.sql.Timestamp<br/> - java.util.Date<br/>
 *
...
public class ParserUtilsTest {
  ...
  public void testParseToNewNumberClassFromUnknownClass() {
    expectedException.expect(ParseException.class);
    expectedException
        .expectMessage("No wrapper found for target class : " + new NewNumberClass().getClass());
  ...
  /**
   * Test for java type:<br/> - java.sql.Date<br/>
   *
   * @author Harvan Irsyadi
   */
